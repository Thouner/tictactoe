...
function selectShape(shape) {
    ...
    removeAnimationAgain();
    setTimeout(addAnimationAgain, 1);
...
function displaylines() {
    ...
    setTimeout(removeAnimationAgainAgain, 1);

}

function removeAnimationAgainAgain() {
    for (let n = 1; n < 10; n++) {
